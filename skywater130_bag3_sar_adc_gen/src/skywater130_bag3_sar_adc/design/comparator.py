...
from skywater130_bag3_sar_adc.layout.sar_comp import SARComp
from skywater130_bag3_sar_adc.measurement.comparator import ComparatorMM
...
class CompDesigner(OptDesigner):
    ...
    def postproc_delay(self, data):
        return {'delay': data['td'][0,:]} #data['outn'][0,0,0]}
