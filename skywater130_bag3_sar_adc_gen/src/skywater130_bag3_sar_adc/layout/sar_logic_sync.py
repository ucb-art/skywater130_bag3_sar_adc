...
class OAICore(MOSBase):
    ...
    def get_schematic_class(cls) -> Optional[Type[Module]]:
        ...
        return ModuleDB.get_schematic_class('skywater130_bag3_sar_adc', 'oai')
...
class SARLogicUnit(MOSBase):
    ...
    def get_schematic_class(cls) -> Optional[Type[Module]]:
        # noinspection PyTypeChecker
        return ModuleDB.get_schematic_class('skywater130_bag3_sar_adc', 'sar_logic_unit_bot_sync')
...
class SARRetUnit(MOSBase):
    ...
    def get_schematic_class(cls) -> Optional[Type[Module]]:
        # noinspection PyTypeChecker
        return ModuleDB.get_schematic_class('skywater130_bag3_sar_adc', 'sar_ret_unit')
...
class SARLogicArray(MOSBase):
    ...
    def get_schematic_class(cls) -> Optional[Type[Module]]:
        # noinspection PyTypeChecker
        return ModuleDB.get_schematic_class('skywater130_bag3_sar_adc', 'sar_logic_array_sync')
