...
from .util_orig import fill_tap_intv, fill_tap
...
class NORNANDDynCore(MOSBase):
    ...
    def get_schematic_class(self) -> Optional[Type[Module]]:
        if self.params['nand']:
            ...
            return ModuleDB.get_schematic_class('skywater130_bag3_sar_adc', 'nand_dyn')
        else:
            # noinspection PyTypeChecker
            return ModuleDB.get_schematic_class('skywater130_bag3_sar_adc', 'nor_dyn')
...
class MuxPGwBuf(MOSBase):
    ...
    def get_schematic_class(self) -> Optional[Type[Module]]:
        # noinspection PyTypeChecker
        return ModuleDB.get_schematic_class('skywater130_bag3_sar_adc', 'mux_pg')
...
class SARAsyncClk(MOSBase):
    ...
    def get_schematic_class(cls) -> Optional[Type[Module]]:
        # noinspection PyTypeChecker
        return ModuleDB.get_schematic_class('skywater130_bag3_sar_adc', 'sar_async_clk_core_v2')
...
class SARAsyncClkSimple(MOSBase, TemplateBaseZL):
    ...
    def get_schematic_class(cls) -> Optional[Type[Module]]:
        # noinspection PyTypeChecker
        return ModuleDB.get_schematic_class('skywater130_bag3_sar_adc', 'sar_async_clk_core_simple')
