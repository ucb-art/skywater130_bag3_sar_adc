...
class HalfLatch(MOSBase):
    ...
    def get_schematic_class(cls) -> Optional[Type[Module]]:
        # noinspection PyTypeChecker
        return ModuleDB.get_schematic_class('skywater130_bag3_sar_adc', 'comp_half_latch')
...
class SA(MOSBase):
    ...
    def get_schematic_class(cls) -> Optional[Type[Module]]:
        # noinspection PyTypeChecker
        return ModuleDB.get_schematic_class('skywater130_bag3_sar_adc', 'comp_strongarm_core')
...
class DualSACore(MOSBase):
    ...
    def get_schematic_class(cls) -> Optional[Type[Module]]:
        # noinspection PyTypeChecker
        return ModuleDB.get_schematic_class('skywater130_bag3_sar_adc', 'comp_dual_strongarm_core')
...
class SARCompCore(MOSBase):
    ...
    def get_schematic_class(cls) -> Optional[Type[Module]]:
        # noinspection PyTypeChecker
        return ModuleDB.get_schematic_class('skywater130_bag3_sar_adc', 'comp_tri_tail_core')
...
class SARComp(MOSBase, TemplateBaseZL):
    ...
    def get_schematic_class(self) -> Optional[Type[Module]]:
        # noinspection PyTypeChecker
        return ModuleDB.get_schematic_class('skywater130_bag3_sar_adc', 'sar_comp_clk') if self.params['clk_params'] else\
            ModuleDB.get_schematic_class('skywater130_bag3_sar_adc', 'sar_comp')
