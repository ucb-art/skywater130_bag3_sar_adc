...
class skywater130_bag3_sar_adc__sar_logic_unit_bot(Module):
    """Module for library skywater130_bag3_sar_adc cell sar_logic_unit_bot.
    ...
    def design(self, nand_done: Param, nand_state: Param, inv_done: Param, buf_state: Param, oai: Param,
        ...
        self.instances['XINV_STATE0'].design(**buf_state[0])
